...
```bash
python src build -S <你的文档> -O dist
```
...
```bash
python src build -S <你的文档> -O dist --base-url /docs --site-url https://example.com/docs/
```
...
```bash
python src watch -S example/source -O dist --interval 1
```
